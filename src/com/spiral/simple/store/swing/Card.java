...
import com.spiral.simple.store.swing.DefaultCardModel.CardType;
...
public class Card extends JComponent implements CardModelListener {
	...
	private static final Dimension 
			DEFAULT_SIZE = new Dimension(300, 100),
			MIN_SIZE = new Dimension(150, 100),
			MAX_SIZE = new Dimension(1000, 105);
	
	public static final Font 
			FONT_TITLE = new Font("Arial", Font.PLAIN, 20),
			FONT_VALUE = new Font("Arial", Font.BOLD, 25),
			FONT_INFO = new Font("Arial", Font.PLAIN, 12);
	...
	protected void paintComponent(Graphics g) {
		...
		//icon
		if (icon != null)
			g2.drawImage(icon, 10, 10, 60, 60, null);
		//==icon
		g2.setColor(model.getBackgroundColor());
